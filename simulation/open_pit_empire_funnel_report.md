...
## Cargo Limit Timing
- Average estimated cargo collected: `26` units against `416` average capacity.
- Highest estimated cargo run: run `30` in `Kernel Vault` with `81` collected of `100` capacity.
- Efficient cargo-limited runs average `76.3%` fuel elapsed before cargo fills; target is `70.0%`.
...
- `Kernel Vault` cargo-limited runs average `72.0%` fuel elapsed before full.
...
| 25 | 48.5m-51.1m | Ghost Sector | Return | 0.31/4 | 64/64 (84% pickup) | 62.0% fuel (90.7s, 64 cap) | 46.3% -> 100.0% (661 blocks, no clear breach reward) | 49960 and core cleared | $20483, 2199 xp, 3 cores | Kernel Breach 1, Salvage Contract 2, Sidechannel 4 | $94855 / 7625 xp / 1 cores |
| 26 | 51.1m-53.8m | Kernel Vault | Return | 0.56/4 | 64/64 (84% pickup) | 72.0% fuel (108.3s, 64 cap) | 0.0% -> 6.5% (783 blocks, Clear Breach I active) | 0 | $53460, 3160 xp, 0 cores | Salvage Contract 3, Zero-Day 1, Salvage Contract 4 | $144053 / 10252 xp / 1 cores |
| 27 | 53.8m-56.5m | Kernel Vault | Return | 0.54/4 | 64/64 (84% pickup) | 72.0% fuel (108.3s, 64 cap) | 6.5% -> 13.0% (783 blocks, Clear Breach I active) | 0 | $53460, 4172 xp, 0 cores | Funnel Resonance 1, Zero-Day 2, Funnel Resonance 2 | $194712 / 13358 xp / 1 cores |
| 28 | 56.5m-59.2m | Kernel Vault | Return | 0.52/4 | 64/64 (84% pickup) | 72.0% fuel (108.3s, 64 cap) | 13.0% -> 21.1% (971 blocks, Clear Breach I active) | 0 | $66112, 6427 xp, 0 cores | Funnel Resonance 3, Zero-Day 3, Funnel Resonance 4 | $250711 / 17654 xp / 1 cores |
| 29 | 59.2m-62.0m | Kernel Vault | Return | 0.49/4 | 64/64 (84% pickup) | 72.0% fuel (108.3s, 64 cap) | 21.1% -> 30.8% (1159 blocks, Clear Breach I active) | 0 | $78765, 9168 xp, 0 cores | Daemon Lances 1, Crash Cartography 1, Daemon Lances 2 | $326067 / 26156 xp / 1 cores |
| 30 | 62.0m-64.7m | Kernel Vault | Return | 0.45/4 | 81/100 (84% pickup) | not full (100 cap) | 30.8% -> 40.5% (1159 blocks, Clear Breach I active) | 0 | $78765, 9168 xp, 0 cores | Daemon Lances 3, Crash Cartography 2, Daemon Lances 4 | $393166 / 33992 xp / 1 cores |
| 31 | 64.7m-67.4m | Kernel Vault | Return | 0.37/4 | 68/136 (84% pickup) | not full (136 cap) | 40.5% -> 47.1% (799 blocks, Clear Breach I active) | 0 | $54550, 6323 xp, 0 cores | Root Breaker 1, Crash Cartography 3, Root Breaker 2 | $426077 / 37651 xp / 1 cores |
| 32 | 67.4m-70.1m | Kernel Vault | Return | 0.35/4 | 52/176 (84% pickup) | not full (176 cap) | 47.1% -> 100.0% (644 blocks, Clear Breach I active) | 252337 and core cleared | $44087, 5093 xp, 3 cores | Root Breaker 3, Kernel Rehearsal 1, Barrier Patch 1 | $441313 / 40187 xp / 1 cores |
| 33 | 70.1m-72.8m | Root Well | Return | 0.77/5 | 39/196 (84% pickup) | not full (196 cap) | 0.0% -> 6.9% (1370 blocks, Clear Breach II active) | 0 | $140627, 13392 xp, 0 cores | Overburn Reactors 1, Kernel Rehearsal 2, Overburn Reactors 2 | $544183 / 48336 xp / 1 cores |
| 34 | 72.8m-75.5m | Root Well | Return | 0.74/5 | 42/240 (84% pickup) | not full (240 cap) | 6.9% -> 15.6% (1754 blocks, Clear Breach II active) | 0 | $179796, 17142 xp, 0 cores | Overburn Reactors 3, Kernel Rehearsal 3, Overburn Reactors 4 | $594757 / 54730 xp / 1 cores |
| 35 | 75.5m-78.2m | Root Well | Return | 0.69/5 | 45/284 (84% pickup) | not full (284 cap) | 15.6% -> 26.3% (2138 blocks, Clear Breach II active) | 0 | $218964, 20891 xp, 0 cores | Seismic Lattice 1, Deep Manifest 1, Seismic Lattice 2 | $759183 / 71927 xp / 1 cores |
| 36 | 78.2m-80.9m | Root Well | Return | 0.64/5 | 36/336 (84% pickup) | not full (336 cap) | 26.3% -> 37.1% (2165 blocks, Clear Breach II active) | 0 | $239477, 21162 xp, 0 cores | Seismic Lattice 3, Deep Manifest 2, Seismic Lattice 4 | $812005 / 85701 xp / 1 cores |
| 37 | 80.9m-83.6m | Root Well | Return | 0.59/5 | 42/388 (84% pickup) | not full (388 cap) | 37.1% -> 51.8% (2941 blocks, Clear Breach II active) | 0 | $349060, 28747 xp, 0 cores | Mantle Drills 1, Deep Manifest 3, Mantle Drills 2 | $967644 / 99672 xp / 1 cores |
| 38 | 83.6m-86.3m | Root Well | Return | 0.46/5 | 27/444 (79% pickup) | not full (444 cap) | 51.8% -> 100.0% (4314 blocks, Clear Breach III active) | 10525608 and core cleared | $546894, 42166 xp, 4 cores | Mantle Drills 3, Deep Manifest 4, Backdoor Exit 1 | $1270351 / 112285 xp / 2 cores |
| 39 | 86.3m-89.0m | Mirror Shelf | Return | 1.05/5 | 8/472 (78% pickup) | not full (472 cap) | 0.0% -> 1.3% (782 blocks, Clear Breach III active) | 0 | $198079, 9828 xp, 0 cores | Mantle Drills 4, Thermal Mapping 1, Fault Charges 1 | $918631 / 114725 xp / 2 cores |
| 40 | 89.0m-91.7m | Mirror Shelf | Return | 1.05/5 | 8/530 (74% pickup) | not full (530 cap) | 1.3% -> 2.9% (945 blocks, Clear Breach III active) | 0 | $239215, 11877 xp, 0 cores | Fault Charges 2, Thermal Mapping 2, Fault Charges 3 | $692124 / 111456 xp / 2 cores |
| 41 | 91.7m-94.4m | Mirror Shelf | Return | 1.04/5 | 9/590 (72% pickup) | not full (590 cap) | 2.9% -> 4.6% (1031 blocks, Clear Breach III active) | 0 | $260894, 12956 xp, 0 cores | Fault Charges 4, Thermal Mapping 3, Void Cutters 1 | $216697 / 93363 xp / 2 cores |
| 42 | 94.4m-97.1m | Mirror Shelf | Return | 1.02/5 | 9/654 (69% pickup) | not full (654 cap) | 4.6% -> 6.8% (1318 blocks, Clear Breach III active) | 0 | $333304, 16563 xp, 0 cores | Void Cutters 2, Thermal Mapping 4, Inversion Drives 1 | $96949 / 46276 xp / 2 cores |
| 43 | 97.1m-99.9m | Mirror Shelf | Return | 1.01/5 | 9/720 (67% pickup) | not full (720 cap) | 6.8% -> 9.8% (1832 blocks, Clear Breach III active) | 0 | $463051, 23024 xp, 0 cores | Void Cutters 3, Vault Heuristics 1, Vault Heuristics 2 | $42811 / 4472 xp / 2 cores |
| 44 | 99.9m-102.6m | Mirror Shelf | Return | 0.99/5 | 9/754 (65% pickup) | not full (754 cap) | 9.8% -> 14.3% (2656 blocks, Clear Breach III active) | 0 | $670818, 33372 xp, 0 cores | Inversion Drives 2 | $356757 / 37844 xp / 2 cores |
| 45 | 102.6m-105.3m | Mirror Shelf | Return | 0.96/5 | 5/786 (65% pickup) | not full (786 cap) | 14.3% -> 17.0% (1652 blocks, Clear Breach III active) | 0 | $417523, 20757 xp, 0 cores | Inversion Drives 3, Graveyard Index 1 | $96224 / 11715 xp / 2 cores |
| 46 | 105.3m-108.0m | Mirror Shelf | Return | 0.94/5 | 5/818 (65% pickup) | not full (818 cap) | 17.0% -> 20.0% (1812 blocks, Clear Breach III active) | 0 | $503568, 25953 xp, 0 cores | Vault Pulsers 1 | $16880 / 37668 xp / 2 cores |
| 47 | 108.0m-110.7m | Mirror Shelf | Return | 0.92/5 | 5/863 (65% pickup) | not full (863 cap) | 20.0% -> 23.4% (2029 blocks, Clear Breach III active) | 0 | $563907, 29067 xp, 0 cores | None | $580787 / 66735 xp / 2 cores |
| 48 | 110.7m-113.4m | Mirror Shelf | Return | 0.90/5 | 5/863 (65% pickup) | not full (863 cap) | 23.4% -> 26.8% (2029 blocks, Clear Breach III active) | 0 | $563907, 29067 xp, 0 cores | Void Cutters 4, Vault Heuristics 3 | $136176 / 6477 xp / 2 cores |
| 49 | 113.4m-116.1m | Mirror Shelf | Return | 0.88/5 | 6/897 (64% pickup) | not full (897 cap) | 26.8% -> 31.0% (2514 blocks, Clear Breach III active) | 0 | $698528, 36015 xp, 0 cores | None | $834704 / 42492 xp / 2 cores |
| 50 | 116.1m-118.8m | Mirror Shelf | Return | 0.85/5 | 6/897 (64% pickup) | not full (897 cap) | 31.0% -> 35.2% (2514 blocks, Clear Breach III active) | 0 | $698528, 36015 xp, 0 cores | Inversion Drives 4, Mirror Daemons 1 | $244925 / 9740 xp / 2 cores |
| 51 | 118.8m-121.5m | Mirror Shelf | Return | 0.82/5 | 4/929 (64% pickup) | not full (929 cap) | 35.2% -> 38.5% (1964 blocks, Clear Breach III active) | 0 | $545920, 28139 xp, 0 cores | None | $790845 / 37879 xp / 2 cores |
| 52 | 121.5m-124.2m | Mirror Shelf | Return | 0.80/5 | 4/929 (64% pickup) | not full (929 cap) | 38.5% -> 41.7% (1964 blocks, Clear Breach III active) | 0 | $545920, 28139 xp, 0 cores | Vault Pulsers 2 | $200087 / 66018 xp / 2 cores |
| 53 | 124.2m-126.9m | Mirror Shelf | Return | 0.69/5 | 4/974 (64% pickup) | not full (974 cap) | 41.7% -> 45.4% (2175 blocks, Clear Breach III active) | 0 | $604332, 31154 xp, 0 cores | Graveyard Index 2 | $804419 / 1055 xp / 2 cores |
| 54 | 126.9m-129.6m | Mirror Shelf | Return | 0.67/5 | 3/974 (64% pickup) | not full (974 cap) | 45.4% -> 100.0% (1752 blocks, Clear Breach III active) | 26735249 and core cleared | $531169, 28178 xp, 2 cores | Gravity Wells 1, Panic Tunnel 1 | $493604 / 29233 xp / 1 cores |
| 55 | 129.6m-132.3m | Reverse Fault | Return | 1.15/5 | 6/1029 (64% pickup) | not full (1029 cap) | 0.0% -> 5.4% (4089 blocks, Clear Breach III active) | 0 | $1548349, 74297 xp, 0 cores | Void Cutters 5 | $75343 / 103530 xp / 1 cores |
| 56 | 132.3m-135.0m | Reverse Fault | Return | 1.11/5 | 6/1063 (63% pickup) | not full (1063 cap) | 5.4% -> 11.3% (4517 blocks, Clear Breach III active) | 0 | $1710308, 82072 xp, 0 cores | Gravity Wells 2, Vault Heuristics 4 | $185881 / 2486 xp / 1 cores |
| 57 | 135.0m-137.8m | Reverse Fault | Return | 1.07/5 | 6/1118 (63% pickup) | not full (1118 cap) | 11.3% -> 18.4% (5414 blocks, Clear Breach III active) | 0 | $2049595, 98360 xp, 0 cores | Vault Pulsers 3 | $18953 / 100846 xp / 1 cores |
| 58 | 137.8m-140.5m | Reverse Fault | Return | 1.02/5 | 3/1163 (63% pickup) | not full (1163 cap) | 18.4% -> 22.6% (3158 blocks, Clear Breach III active) | 0 | $1196023, 57382 xp, 0 cores | Mirror Daemons 2 | $1214976 / 13818 xp / 1 cores |
| 59 | 140.5m-143.2m | Reverse Fault | Return | 0.99/5 | 3/1163 (63% pickup) | not full (1163 cap) | 22.6% -> 27.2% (3497 blocks, Clear Breach III active) | 0 | $1324089, 63531 xp, 0 cores | Abyssal Rigs 1 | $1178937 / 77349 xp / 1 cores |
| 60 | 143.2m-145.9m | Reverse Fault | Return | 0.96/5 | 3/1238 (63% pickup) | not full (1238 cap) | 27.2% -> 32.4% (3986 blocks, Clear Breach III active) | 0 | $1509461, 72425 xp, 0 cores | Abyssal Rigs 2, Inversion Ledger 1 | $76952 / 34121 xp / 1 cores |
| 61 | 145.9m-148.6m | Reverse Fault | Return | 0.92/5 | 2/1313 (63% pickup) | not full (1313 cap) | 32.4% -> 36.6% (3189 blocks, Clear Breach III active) | 0 | $1207842, 67210 xp, 0 cores | None | $1284794 / 101331 xp / 1 cores |
| 62 | 148.6m-151.3m | Reverse Fault | Return | 0.89/5 | 2/1313 (63% pickup) | not full (1313 cap) | 36.6% -> 40.8% (3189 blocks, Clear Breach III active) | 0 | $1207842, 67210 xp, 0 cores | Mirror Saws 1 | $484828 / 168541 xp / 1 cores |
