...
const BRANCH_OFFENSE := 5
const BRANCH_LOGISTICS := 6
const BRANCH_SYSTEMS := 7
...
const BRANCH_THEME_BY_ID := {
    ...
    "laser_cutter": {"group": BRANCH_OFFENSE, "pos": 1, "act": ACT_OFFENSE},
    "rapid_cycle": {"group": BRANCH_OFFENSE, "pos": 2, "act": ACT_OFFENSE},
    "shock_bits": {"group": BRANCH_OFFENSE, "pos": 3, "act": ACT_OFFENSE},
    "daemon_lances": {"group": BRANCH_OFFENSE, "pos": 4, "act": ACT_OFFENSE},
    "root_breaker": {"group": BRANCH_OFFENSE, "pos": 5, "act": ACT_OFFENSE},
    "mantle_drills": {"group": BRANCH_OFFENSE, "pos": 6, "act": ACT_OFFENSE},
    "fault_charges": {"group": BRANCH_OFFENSE, "pos": 7, "act": ACT_OFFENSE},
    "void_cutters": {"group": BRANCH_OFFENSE, "pos": 8, "act": ACT_OFFENSE},
    "mirror_saws": {"group": BRANCH_OFFENSE, "pos": 9, "act": ACT_OFFENSE},
    "null_borers": {"group": BRANCH_OFFENSE, "pos": 10, "act": ACT_OFFENSE},
    "cargo_racks": {"group": BRANCH_LOGISTICS, "pos": 1, "act": ACT_LOGISTICS},
    "fuel_cells": {"group": BRANCH_LOGISTICS, "pos": 2, "act": ACT_LOGISTICS},
    "ore_appraisal": {"group": BRANCH_LOGISTICS, "pos": 3, "act": ACT_LOGISTICS},
    "salvage_contract": {"group": BRANCH_LOGISTICS, "pos": 4, "act": ACT_LOGISTICS},
    "auto_salvage": {"group": BRANCH_LOGISTICS, "pos": 5, "act": ACT_LOGISTICS},
    "abyssal_rigs": {"group": BRANCH_LOGISTICS, "pos": 6, "act": ACT_LOGISTICS},
    "ash_crowns": {"group": BRANCH_LOGISTICS, "pos": 7, "act": ACT_LOGISTICS},
    "minimap": {"group": BRANCH_SYSTEMS, "pos": 1, "act": ACT_SYSTEMS},
    "breach_drones": {"group": BRANCH_SYSTEMS, "pos": 2, "act": ACT_SYSTEMS},
    "funnel_resonance": {"group": BRANCH_SYSTEMS, "pos": 3, "act": ACT_SYSTEMS},
    "overburn_reactors": {"group": BRANCH_SYSTEMS, "pos": 4, "act": ACT_SYSTEMS},
    "seismic_lattice": {"group": BRANCH_SYSTEMS, "pos": 5, "act": ACT_SYSTEMS},
    "inversion_drives": {"group": BRANCH_SYSTEMS, "pos": 6, "act": ACT_SYSTEMS},
    "vault_pulsers": {"group": BRANCH_SYSTEMS, "pos": 7, "act": ACT_SYSTEMS},
    "gravity_wells": {"group": BRANCH_SYSTEMS, "pos": 8, "act": ACT_SYSTEMS},
    "fault_harpoons": {"group": BRANCH_SYSTEMS, "pos": 9, "act": ACT_SYSTEMS},
    ...
    "core:kernel_breach": {"group": BRANCH_CORE_PATH, "pos": 8, "act": ACT_SURVIVAL},
    "core:center_unlock": {"group": BRANCH_CORE_PATH, "pos": 9, "act": ACT_SURVIVAL},
    "core:core_siphon": {"group": BRANCH_CORE_PATH, "pos": 10, "act": ACT_SURVIVAL},
    "core:salvage_limiter": {"group": BRANCH_CORE_PATH, "pos": 11, "act": ACT_SURVIVAL},
    "core:mantle_permits": {"group": BRANCH_CORE_PATH, "pos": 12, "act": ACT_SURVIVAL},
    "core:inversion_tether": {"group": BRANCH_CORE_PATH, "pos": 13, "act": ACT_SURVIVAL},
    "core:voidfire_brakes": {"group": BRANCH_CORE_PATH, "pos": 14, "act": ACT_SURVIVAL},
    "core:mirror_keys": {"group": BRANCH_CORE_PATH, "pos": 15, "act": ACT_SURVIVAL},
    "core:fault_insulation": {"group": BRANCH_CORE_PATH, "pos": 16, "act": ACT_SURVIVAL},
    "core:null_anchor": {"group": BRANCH_CORE_PATH, "pos": 17, "act": ACT_SURVIVAL},
    "core:ash_ward": {"group": BRANCH_CORE_PATH, "pos": 18, "act": ACT_SURVIVAL},
    "core:planet_mastery": {"group": BRANCH_CORE_PATH, "pos": 19, "act": ACT_SURVIVAL},
}
