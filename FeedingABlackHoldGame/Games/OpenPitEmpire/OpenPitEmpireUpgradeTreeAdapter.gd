...
const BRANCH_CASH_BLOCK_1 := 11
const BRANCH_CASH_BLOCK_2 := 12
const BRANCH_CASH_BLOCK_3 := 13
const BRANCH_CASH_BLOCK_4 := 14
const BRANCH_CASH_BLOCK_5 := 15
const BRANCH_XP_BLOCK_1 := 16
const BRANCH_XP_BLOCK_2 := 17
const BRANCH_XP_BLOCK_3 := 18
...
const BRANCH_THEME_BY_ID := {
    ...
    "minimap": {"group": BRANCH_CASH_BLOCK_1, "pos": 1, "act": ACT_LOGISTICS},
    "laser_cutter": {"group": BRANCH_CASH_BLOCK_1, "pos": 2, "act": ACT_LOGISTICS},
    "cargo_racks": {"group": BRANCH_CASH_BLOCK_1, "pos": 3, "act": ACT_LOGISTICS},
    "fuel_cells": {"group": BRANCH_CASH_BLOCK_1, "pos": 4, "act": ACT_LOGISTICS},
    "rapid_cycle": {"group": BRANCH_CASH_BLOCK_1, "pos": 5, "act": ACT_LOGISTICS},
    "ore_appraisal": {"group": BRANCH_CASH_BLOCK_1, "pos": 6, "act": ACT_LOGISTICS},
    "survey_drone": {"group": BRANCH_CASH_BLOCK_1, "pos": 7, "act": ACT_LOGISTICS},
    "barrier_mesh": {"group": BRANCH_CASH_BLOCK_2, "pos": 1, "act": ACT_OFFENSE},
    "shock_bits": {"group": BRANCH_CASH_BLOCK_2, "pos": 2, "act": ACT_OFFENSE},
    "breach_drones": {"group": BRANCH_CASH_BLOCK_2, "pos": 3, "act": ACT_OFFENSE},
    "salvage_contract": {"group": BRANCH_CASH_BLOCK_2, "pos": 4, "act": ACT_OFFENSE},
    "funnel_resonance": {"group": BRANCH_CASH_BLOCK_2, "pos": 5, "act": ACT_OFFENSE},
    "tunnel_drone": {"group": BRANCH_CASH_BLOCK_2, "pos": 6, "act": ACT_OFFENSE},
    "daemon_lances": {"group": BRANCH_CASH_BLOCK_2, "pos": 7, "act": ACT_OFFENSE},
    "drone_frenzy_link": {"group": BRANCH_CASH_BLOCK_2, "pos": 8, "act": ACT_OFFENSE},
    "root_breaker": {"group": BRANCH_CASH_BLOCK_3, "pos": 1, "act": ACT_SYSTEMS},
    "overburn_reactors": {"group": BRANCH_CASH_BLOCK_3, "pos": 2, "act": ACT_SYSTEMS},
    "seismic_lattice": {"group": BRANCH_CASH_BLOCK_3, "pos": 3, "act": ACT_SYSTEMS},
    "auto_salvage": {"group": BRANCH_CASH_BLOCK_3, "pos": 4, "act": ACT_SYSTEMS},
    "mantle_drills": {"group": BRANCH_CASH_BLOCK_3, "pos": 5, "act": ACT_SYSTEMS},
    "strata_drone": {"group": BRANCH_CASH_BLOCK_3, "pos": 6, "act": ACT_SYSTEMS},
    "fault_charges": {"group": BRANCH_CASH_BLOCK_3, "pos": 7, "act": ACT_SYSTEMS},
    "drone_frenzy_thrusters": {"group": BRANCH_CASH_BLOCK_3, "pos": 8, "act": ACT_SYSTEMS},
    "void_cutters": {"group": BRANCH_CASH_BLOCK_4, "pos": 1, "act": ACT_SURVIVAL},
    "inversion_drives": {"group": BRANCH_CASH_BLOCK_4, "pos": 2, "act": ACT_SURVIVAL},
    "vault_pulsers": {"group": BRANCH_CASH_BLOCK_4, "pos": 3, "act": ACT_SURVIVAL},
    "gravity_wells": {"group": BRANCH_CASH_BLOCK_4, "pos": 4, "act": ACT_SURVIVAL},
    "drone_split_lasers": {"group": BRANCH_CASH_BLOCK_4, "pos": 5, "act": ACT_SURVIVAL},
    "core_mining_drone": {"group": BRANCH_CASH_BLOCK_4, "pos": 6, "act": ACT_SURVIVAL},
    "abyssal_rigs": {"group": BRANCH_CASH_BLOCK_4, "pos": 7, "act": ACT_SURVIVAL},
    "drone_frenzy_harvesters": {"group": BRANCH_CASH_BLOCK_4, "pos": 8, "act": ACT_SURVIVAL},
    "mirror_saws": {"group": BRANCH_CASH_BLOCK_5, "pos": 1, "act": ACT_REWARD},
    "fault_harpoons": {"group": BRANCH_CASH_BLOCK_5, "pos": 2, "act": ACT_REWARD},
    "null_borers": {"group": BRANCH_CASH_BLOCK_5, "pos": 3, "act": ACT_REWARD},
    "ash_crowns": {"group": BRANCH_CASH_BLOCK_5, "pos": 4, "act": ACT_REWARD},
    "drone_frenzy_matrix": {"group": BRANCH_CASH_BLOCK_5, "pos": 5, "act": ACT_REWARD},
    "mining_speed_servos": {"group": BRANCH_CASH_BLOCK_5, "pos": 6, "act": ACT_REWARD},
    "mining_speed_coolant": {"group": BRANCH_CASH_BLOCK_5, "pos": 7, "act": ACT_REWARD},
    "mining_speed_overdrive": {"group": BRANCH_CASH_BLOCK_5, "pos": 8, "act": ACT_REWARD},
    "xp:packet_sniffer": {"group": BRANCH_XP_BLOCK_1, "pos": 1, "act": ACT_SYSTEMS},
    "xp:trace_scrubber": {"group": BRANCH_XP_BLOCK_1, "pos": 2, "act": ACT_SYSTEMS},
    "xp:heap_climber": {"group": BRANCH_XP_BLOCK_1, "pos": 3, "act": ACT_SYSTEMS},
    "xp:cache_warmers": {"group": BRANCH_XP_BLOCK_1, "pos": 4, "act": ACT_SYSTEMS},
    "xp:deep_scan": {"group": BRANCH_XP_BLOCK_1, "pos": 5, "act": ACT_SYSTEMS},
    "xp:sidechannel": {"group": BRANCH_XP_BLOCK_1, "pos": 6, "act": ACT_SYSTEMS},
    "xp:zero_day": {"group": BRANCH_XP_BLOCK_2, "pos": 1, "act": ACT_OFFENSE},
    "xp:crash_cartography": {"group": BRANCH_XP_BLOCK_2, "pos": 2, "act": ACT_OFFENSE},
    "xp:kernel_rehearsal": {"group": BRANCH_XP_BLOCK_2, "pos": 3, "act": ACT_OFFENSE},
    "xp:deep_manifest": {"group": BRANCH_XP_BLOCK_2, "pos": 4, "act": ACT_OFFENSE},
    "xp:thermal_mapping": {"group": BRANCH_XP_BLOCK_2, "pos": 5, "act": ACT_OFFENSE},
    "xp:vault_heuristics": {"group": BRANCH_XP_BLOCK_2, "pos": 6, "act": ACT_OFFENSE},
    "xp:graveyard_index": {"group": BRANCH_XP_BLOCK_3, "pos": 1, "act": ACT_SURVIVAL},
    "xp:mirror_daemons": {"group": BRANCH_XP_BLOCK_3, "pos": 2, "act": ACT_SURVIVAL},
    "xp:inversion_ledger": {"group": BRANCH_XP_BLOCK_3, "pos": 3, "act": ACT_SURVIVAL},
    "xp:fault_oracles": {"group": BRANCH_XP_BLOCK_3, "pos": 4, "act": ACT_SURVIVAL},
    "xp:null_archive": {"group": BRANCH_XP_BLOCK_3, "pos": 5, "act": ACT_SURVIVAL},
    "xp:ash_scriptures": {"group": BRANCH_XP_BLOCK_3, "pos": 6, "act": ACT_SURVIVAL},
