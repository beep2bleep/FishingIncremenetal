...
const BRANCH_THEME_BY_ID := {
    ...
    "core:core_stasis": {"group": BRANCH_CORE_PATH, "pos": 9, "act": ACT_SURVIVAL},
    "core:center_unlock": {"group": BRANCH_CORE_PATH, "pos": 10, "act": ACT_SURVIVAL},
    "core:core_siphon": {"group": BRANCH_CORE_PATH, "pos": 11, "act": ACT_SURVIVAL},
    "core:salvage_limiter": {"group": BRANCH_CORE_PATH, "pos": 12, "act": ACT_SURVIVAL},
    "core:mantle_permits": {"group": BRANCH_CORE_PATH, "pos": 13, "act": ACT_SURVIVAL},
    "core:inversion_tether": {"group": BRANCH_CORE_PATH, "pos": 14, "act": ACT_SURVIVAL},
    "core:voidfire_brakes": {"group": BRANCH_CORE_PATH, "pos": 15, "act": ACT_SURVIVAL},
    "core:mirror_keys": {"group": BRANCH_CORE_PATH, "pos": 16, "act": ACT_SURVIVAL},
    "core:fault_insulation": {"group": BRANCH_CORE_PATH, "pos": 17, "act": ACT_SURVIVAL},
    "core:null_anchor": {"group": BRANCH_CORE_PATH, "pos": 18, "act": ACT_SURVIVAL},
    "core:ash_ward": {"group": BRANCH_CORE_PATH, "pos": 19, "act": ACT_SURVIVAL},
    "core:planet_mastery": {"group": BRANCH_CORE_PATH, "pos": 20, "act": ACT_SURVIVAL},
}
