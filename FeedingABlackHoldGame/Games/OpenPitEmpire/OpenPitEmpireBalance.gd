...
const XP_UPGRADES := {
    ...
    "crash_cartography": {"base_cost": 150, "cost_mult": 2.00, "max_level": 3, "label": "Crash Cartography", "summary": "+12% global damage per level.", "icon": "M", "effects": {"global_damage_mult": 0.12}},
    ...
    "vault_heuristics": {"base_cost": 340, "cost_mult": 2.05, "max_level": 4, "label": "Vault Heuristics", "summary": "+7 damage and +10 range per level.", "icon": "V", "effects": {"damage_flat": 7.0, "range": 10.0}},
...
const RAW_NODE_DATA := {
    ...
    "cargo_racks": {"base_cost": 65, "cost_mult": 1.52, "max_level": 7, "phase": 1, "label": "Cargo Racks", "summary": "+5 cargo capacity per level.", "icon": "C", "effects": {"cargo_expand": 5.0}},
...
static func build_runtime_stats(upgrades: Dictionary, xp_upgrades: Dictionary = {}, core_upgrades: Dictionary = {}) -> Dictionary:
    ...
    return {
        ...
        "cargo_capacity": int(14 + cargo_bonus),
