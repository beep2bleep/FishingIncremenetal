...
const CORE_UPGRADES := {
    ...
    "return_shortcut": {"base_cost": 2, "cost_mult": 1.0, "max_level": 1, "label": "Backdoor Exit", "summary": "Makes the surface extraction zone larger and opens a small exit at the defeated center kernel.", "icon": "E", "effects": {}},
