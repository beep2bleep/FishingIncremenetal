...
const XP_LAYOUT := {
    "xp:packet_sniffer": Vector2(-8, 4),
    "xp:trace_scrubber": Vector2(-11, 7),
    "xp:heap_climber": Vector2(-8, 7),
    "xp:cache_warmers": Vector2(-5, 7),
    "xp:deep_scan": Vector2(-11, 10),
    "xp:sidechannel": Vector2(-5, 10),
    "xp:zero_day": Vector2(-8, 13),
    "xp:crash_cartography": Vector2(-11, 16),
    "xp:kernel_rehearsal": Vector2(-8, 16),
    "xp:deep_manifest": Vector2(-5, 16),
    "xp:thermal_mapping": Vector2(-11, 19),
    "xp:vault_heuristics": Vector2(-5, 19),
    "xp:graveyard_index": Vector2(-8, 22),
    "xp:mirror_daemons": Vector2(-11, 25),
    "xp:inversion_ledger": Vector2(-8, 25),
    "xp:fault_oracles": Vector2(-5, 25),
    "xp:null_archive": Vector2(-11, 28),
    "xp:ash_scriptures": Vector2(-5, 28),
}
...
const CORE_LAYOUT := {
    "core:clear_proxy_25": Vector2(-2, -4),
    "core:clear_proxy_50": Vector2(-2, -8),
    "core:clear_proxy_75": Vector2(-2, -12),
    "core:clear_cipher_25": Vector2(-1, -4),
    "core:clear_cipher_50": Vector2(-1, -8),
    "core:clear_cipher_75": Vector2(-1, -12),
    "core:clear_ghost_25": Vector2(0, -4),
    "core:clear_ghost_50": Vector2(0, -8),
    "core:clear_ghost_75": Vector2(0, -12),
    "core:clear_kernel_25": Vector2(1, -4),
    "core:clear_kernel_50": Vector2(1, -8),
    "core:clear_kernel_75": Vector2(1, -12),
    "core:core_detect": Vector2(12, 2),
    "core:spawn_direction": Vector2(14, 2),
    "core:brake": Vector2(16, 2),
    "core:barrier_regen": Vector2(12, 4),
    "core:return_shortcut": Vector2(14, 4),
    "core:emergency_return": Vector2(16, 4),
    "core:core_focus": Vector2(12, 6),
    "core:countermeasure_bridge": Vector2(14, 6),
    "core:kernel_breach": Vector2(16, 6),
    "core:core_stasis": Vector2(12, 8),
    "core:center_unlock": Vector2(14, 8),
    "core:core_siphon": Vector2(16, 8),
    "core:salvage_limiter": Vector2(12, 10),
    "core:mantle_permits": Vector2(14, 10),
    "core:inversion_tether": Vector2(16, 10),
    "core:voidfire_brakes": Vector2(12, 12),
    "core:mirror_keys": Vector2(14, 12),
    "core:fault_insulation": Vector2(16, 12),
    "core:null_anchor": Vector2(12, 14),
    "core:ash_ward": Vector2(14, 14),
    "core:autopilot_drone": Vector2(16, 14),
    "core:planet_mastery": Vector2(14, 16),
}
...
const UPGRADE_CELL_OVERRIDES := {
    "minimap": Vector2(4, 4),
    "laser_cutter": Vector2(1, 7),
    "cargo_racks": Vector2(4, 7),
    "fuel_cells": Vector2(7, 7),
    "rapid_cycle": Vector2(1, 10),
    "ore_appraisal": Vector2(7, 10),
    "survey_drone": Vector2(4, 12),
    "barrier_mesh": Vector2(4, 15),
    "shock_bits": Vector2(1, 18),
    "breach_drones": Vector2(4, 18),
    "salvage_contract": Vector2(7, 18),
    "funnel_resonance": Vector2(1, 21),
    "tunnel_drone": Vector2(4, 21),
    "daemon_lances": Vector2(7, 21),
    "drone_frenzy_link": Vector2(4, 24),
    "root_breaker": Vector2(4, 27),
    "overburn_reactors": Vector2(1, 30),
    "seismic_lattice": Vector2(4, 30),
    "auto_salvage": Vector2(7, 30),
    "mantle_drills": Vector2(1, 33),
    "strata_drone": Vector2(4, 33),
    "fault_charges": Vector2(7, 33),
    "drone_frenzy_thrusters": Vector2(4, 36),
    "void_cutters": Vector2(4, 39),
    "inversion_drives": Vector2(1, 42),
    "vault_pulsers": Vector2(4, 42),
    "gravity_wells": Vector2(7, 42),
    "drone_split_lasers": Vector2(1, 45),
    "core_mining_drone": Vector2(4, 45),
    "abyssal_rigs": Vector2(7, 45),
    "drone_frenzy_harvesters": Vector2(4, 48),
    "mirror_saws": Vector2(4, 51),
    "fault_harpoons": Vector2(1, 54),
    "null_borers": Vector2(4, 54),
    "ash_crowns": Vector2(7, 54),
    "drone_frenzy_matrix": Vector2(1, 57),
    "mining_speed_servos": Vector2(7, 57),
    "mining_speed_coolant": Vector2(7, 60),
    "mining_speed_overdrive": Vector2(7, 63),
}
