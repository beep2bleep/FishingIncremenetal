...
const XP_LAYOUT := {
    "xp:packet_sniffer": Vector2(-4, 2),
    "xp:trace_scrubber": Vector2(-5, 3),
    "xp:heap_climber": Vector2(-4, 3),
    "xp:cache_warmers": Vector2(-3, 3),
    "xp:deep_scan": Vector2(-5, 4),
    "xp:sidechannel": Vector2(-3, 4),
    "xp:zero_day": Vector2(-4, 5),
    "xp:crash_cartography": Vector2(-5, 6),
    "xp:kernel_rehearsal": Vector2(-4, 6),
    "xp:deep_manifest": Vector2(-3, 6),
    "xp:thermal_mapping": Vector2(-5, 7),
    "xp:vault_heuristics": Vector2(-3, 7),
    "xp:graveyard_index": Vector2(-4, 8),
    "xp:mirror_daemons": Vector2(-5, 9),
    "xp:inversion_ledger": Vector2(-4, 9),
    "xp:fault_oracles": Vector2(-3, 9),
    "xp:null_archive": Vector2(-5, 10),
    "xp:ash_scriptures": Vector2(-3, 10),
}
const XP_CONNECTIONS := {
    "xp:packet_sniffer": [],
    "xp:trace_scrubber": ["xp:packet_sniffer"],
    "xp:heap_climber": ["xp:packet_sniffer"],
    "xp:cache_warmers": ["xp:packet_sniffer"],
    "xp:deep_scan": ["xp:trace_scrubber"],
    "xp:sidechannel": ["xp:cache_warmers"],
    "xp:zero_day": ["xp:sidechannel"],
    "xp:crash_cartography": ["xp:zero_day"],
    "xp:kernel_rehearsal": ["xp:zero_day"],
    "xp:deep_manifest": ["xp:zero_day"],
    "xp:thermal_mapping": ["xp:crash_cartography"],
    "xp:vault_heuristics": ["xp:deep_manifest"],
    "xp:graveyard_index": ["xp:vault_heuristics"],
    "xp:mirror_daemons": ["xp:graveyard_index"],
    "xp:inversion_ledger": ["xp:graveyard_index"],
    "xp:fault_oracles": ["xp:graveyard_index"],
    "xp:null_archive": ["xp:mirror_daemons"],
    "xp:ash_scriptures": ["xp:fault_oracles"],
}
const XP_UPGRADES := {
    ...
    "vault_heuristics": {"base_cost": 340, "cost_mult": 2.12, "max_level": 8, "label": "Vault Heuristics", "summary": "+7 damage and +10 range per level.", "icon": "V", "effects": {"damage_flat": 7.0, "range": 10.0}},
    "graveyard_index": {"base_cost": 750, "cost_mult": 2.14, "max_level": 8, "label": "Graveyard Index", "summary": "+14% XP and +6 payout per level.", "icon": "G", "effects": {"xp_gain_mult": 0.14, "resource_flat": 6.0}},
    "mirror_daemons": {"base_cost": 1100, "cost_mult": 2.16, "max_level": 9, "label": "Mirror Daemons", "summary": "Unlocks deeper electric chaining and +1 range step per level.", "icon": "M", "effects": {"electric_unlock": true, "electric_range": 1}},
    "inversion_ledger": {"base_cost": 1850, "cost_mult": 2.18, "max_level": 9, "label": "Inversion Ledger", "summary": "+16% XP and +8 payout per level.", "icon": "I", "effects": {"xp_gain_mult": 0.16, "resource_flat": 8.0}},
    "fault_oracles": {"base_cost": 2800, "cost_mult": 2.20, "max_level": 10, "label": "Fault Oracles", "summary": "Unlock chain lightning and add +1 chain depth per level.", "icon": "F", "effects": {"chain_lightning_unlock": true, "electric_chain": 1}},
...
const REWARD_CORE_UPGRADES := [
    ...
    "clear_ghost_25", "clear_ghost_50", "clear_ghost_75",
...
const CORE_ORDER := [
    ...
    "core_focus", "countermeasure_bridge", "kernel_breach", "core_stasis", "center_unlock",
...
const CORE_LAYOUT := {
    ...
    "core:clear_proxy_50": Vector2(-2, -4),
    "core:clear_proxy_75": Vector2(-2, -6),
    "core:clear_cipher_25": Vector2(-1, -2),
    "core:clear_cipher_50": Vector2(-1, -4),
    "core:clear_cipher_75": Vector2(-1, -6),
    "core:clear_ghost_25": Vector2(0, -2),
    "core:clear_ghost_50": Vector2(0, -4),
    "core:clear_ghost_75": Vector2(0, -6),
    "core:clear_kernel_25": Vector2(1, -2),
    "core:clear_kernel_50": Vector2(1, -4),
    "core:clear_kernel_75": Vector2(1, -6),
    "core:core_detect": Vector2(3, 2),
    "core:spawn_direction": Vector2(5, 2),
    "core:brake": Vector2(7, 2),
    "core:barrier_regen": Vector2(3, 4),
    "core:return_shortcut": Vector2(5, 4),
    "core:emergency_return": Vector2(7, 4),
    "core:core_focus": Vector2(3, 6),
    "core:countermeasure_bridge": Vector2(5, 6),
    "core:kernel_breach": Vector2(7, 6),
    "core:core_stasis": Vector2(3, 8),
    "core:center_unlock": Vector2(5, 8),
    "core:core_siphon": Vector2(7, 8),
    "core:salvage_limiter": Vector2(3, 10),
    "core:mantle_permits": Vector2(5, 10),
    "core:inversion_tether": Vector2(7, 10),
    "core:voidfire_brakes": Vector2(3, 12),
    "core:mirror_keys": Vector2(5, 12),
    "core:fault_insulation": Vector2(7, 12),
    "core:null_anchor": Vector2(3, 14),
...
const CORE_CONNECTIONS := {
    "core:clear_proxy_25": [],
    "core:clear_proxy_50": ["core:clear_proxy_25"],
    "core:clear_proxy_75": ["core:clear_proxy_50"],
    "core:clear_cipher_25": [],
    "core:clear_cipher_50": ["core:clear_cipher_25"],
    "core:clear_cipher_75": ["core:clear_cipher_50"],
    "core:clear_ghost_25": [],
    "core:clear_ghost_50": ["core:clear_ghost_25"],
    "core:clear_ghost_75": ["core:clear_ghost_50"],
    "core:clear_kernel_25": [],
    "core:clear_kernel_50": ["core:clear_kernel_25"],
    "core:clear_kernel_75": ["core:clear_kernel_50"],
    "core:core_detect": [],
    ...
    "core:countermeasure_bridge": ["core:core_focus"],
    "core:kernel_breach": ["core:countermeasure_bridge"],
...
const CORE_UPGRADES := {
    ...
    "clear_proxy_50": {"base_cost": 1, "cost_mult": 1.0, "max_level": 1, "label": "Proxy Cache 50%", "summary": "Auto-awarded at 50% clear of Proxy Cache. Adds +50% global damage.", "icon": "P", "effects": {"global_damage_mult": 0.50}},
    "clear_proxy_75": {"base_cost": 1, "cost_mult": 1.0, "max_level": 1, "label": "Proxy Cache 75%", "summary": "Auto-awarded at 75% clear of Proxy Cache. Adds +50% global damage.", "icon": "P", "effects": {"global_damage_mult": 0.50}},
    "clear_cipher_25": {"base_cost": 1, "cost_mult": 1.0, "max_level": 1, "label": "Cipher Depths 25%", "summary": "Auto-awarded at 25% clear of Cipher Depths. Adds +50% global damage.", "icon": "C", "effects": {"global_damage_mult": 0.50}},
    "clear_cipher_50": {"base_cost": 1, "cost_mult": 1.0, "max_level": 1, "label": "Cipher Depths 50%", "summary": "Auto-awarded at 50% clear of Cipher Depths. Adds +50% global damage.", "icon": "C", "effects": {"global_damage_mult": 0.50}},
    "clear_cipher_75": {"base_cost": 1, "cost_mult": 1.0, "max_level": 1, "label": "Cipher Depths 75%", "summary": "Auto-awarded at 75% clear of Cipher Depths. Adds +50% global damage.", "icon": "C", "effects": {"global_damage_mult": 0.50}},
    "clear_ghost_25": {"base_cost": 1, "cost_mult": 1.0, "max_level": 1, "label": "Ghost Sector 25%", "summary": "Auto-awarded at 25% clear of Ghost Sector. Adds +50% global damage.", "icon": "G", "effects": {"global_damage_mult": 0.50}},
    "clear_ghost_50": {"base_cost": 1, "cost_mult": 1.0, "max_level": 1, "label": "Ghost Sector 50%", "summary": "Auto-awarded at 50% clear of Ghost Sector. Adds +50% global damage.", "icon": "G", "effects": {"global_damage_mult": 0.50}},
    "clear_ghost_75": {"base_cost": 1, "cost_mult": 1.0, "max_level": 1, "label": "Ghost Sector 75%", "summary": "Auto-awarded at 75% clear of Ghost Sector. Adds +50% global damage.", "icon": "G", "effects": {"global_damage_mult": 0.50}},
    "clear_kernel_25": {"base_cost": 1, "cost_mult": 1.0, "max_level": 1, "label": "Kernel Vault 25%", "summary": "Auto-awarded at 25% clear of Kernel Vault. Adds +50% global damage.", "icon": "K", "effects": {"global_damage_mult": 0.50}},
    "clear_kernel_50": {"base_cost": 1, "cost_mult": 1.0, "max_level": 1, "label": "Kernel Vault 50%", "summary": "Auto-awarded at 50% clear of Kernel Vault. Adds +50% global damage.", "icon": "K", "effects": {"global_damage_mult": 0.50}},
    "clear_kernel_75": {"base_cost": 1, "cost_mult": 1.0, "max_level": 1, "label": "Kernel Vault 75%", "summary": "Auto-awarded at 75% clear of Kernel Vault. Adds +50% global damage.", "icon": "K", "effects": {"global_damage_mult": 0.50}},
    ...
    "spawn_direction": {"base_cost": 1, "cost_mult": 1.0, "max_level": 1, "label": "Auto Vent", "summary": "Automatically triggers full power when charged, but manual activation still works.", "icon": "A", "effects": {"power_auto_trigger": true}},
    ...
    "return_shortcut": {"base_cost": 2, "cost_mult": 1.0, "max_level": 1, "label": "Backdoor Exit", "summary": "Makes the surface extraction zone larger and opens a small exit at the deepest defeated kernel.", "icon": "E", "effects": {}},
    ...
    "mirror_keys": {"base_cost": 9, "cost_mult": 1.0, "max_level": 1, "label": "Mirror Keys", "summary": "Unlock crit routing and add +14 damage.", "icon": "M", "effects": {"critical_unlock": true, "damage_flat": 14.0}},
...
const PHASE_NODE_ORDER := {
    1: ["start", "minimap", "laser_cutter", "cargo_racks", "fuel_cells", "rapid_cycle", "ore_appraisal", "survey_drone"],
...
const UPGRADE_CELL_OVERRIDES := {
    "minimap": Vector2(0, 2),
    "laser_cutter": Vector2(-1, 3),
    "cargo_racks": Vector2(0, 3),
    "fuel_cells": Vector2(1, 3),
    "rapid_cycle": Vector2(-1, 4),
    "ore_appraisal": Vector2(1, 4),
    "survey_drone": Vector2(0, 5),
    "barrier_mesh": Vector2(0, 6),
    "shock_bits": Vector2(-1, 7),
    "breach_drones": Vector2(0, 7),
    "salvage_contract": Vector2(1, 7),
    "funnel_resonance": Vector2(-1, 8),
    "tunnel_drone": Vector2(0, 8),
    "daemon_lances": Vector2(1, 8),
    "drone_frenzy_link": Vector2(0, 9),
    "root_breaker": Vector2(0, 10),
    "overburn_reactors": Vector2(-1, 11),
    "seismic_lattice": Vector2(0, 11),
    "auto_salvage": Vector2(1, 11),
    "mantle_drills": Vector2(-1, 12),
    "strata_drone": Vector2(0, 12),
    "fault_charges": Vector2(1, 12),
    "drone_frenzy_thrusters": Vector2(0, 13),
    "void_cutters": Vector2(0, 14),
    "inversion_drives": Vector2(-1, 15),
    "vault_pulsers": Vector2(0, 15),
    "gravity_wells": Vector2(1, 15),
    "drone_split_lasers": Vector2(-1, 16),
    "core_mining_drone": Vector2(0, 16),
    "abyssal_rigs": Vector2(1, 16),
    "drone_frenzy_harvesters": Vector2(0, 17),
    "mirror_saws": Vector2(0, 18),
    "fault_harpoons": Vector2(-1, 19),
    "null_borers": Vector2(0, 19),
    "ash_crowns": Vector2(1, 19),
    "drone_frenzy_matrix": Vector2(-1, 20),
    "mining_speed_servos": Vector2(1, 20),
    "mining_speed_coolant": Vector2(1, 21),
    "mining_speed_overdrive": Vector2(1, 22),
}

const UPGRADE_DEPENDENCY_OVERRIDES := {
    "minimap": "",
    "laser_cutter": "minimap",
    "cargo_racks": "minimap",
    "fuel_cells": "minimap",
    "rapid_cycle": "laser_cutter",
    "ore_appraisal": "fuel_cells",
    "survey_drone": "cargo_racks",
    "barrier_mesh": "ore_appraisal",
    "shock_bits": "barrier_mesh",
    "breach_drones": "barrier_mesh",
    "salvage_contract": "barrier_mesh",
    "funnel_resonance": "shock_bits",
    "tunnel_drone": "breach_drones",
    "daemon_lances": "salvage_contract",
    "drone_frenzy_link": "tunnel_drone",
    "root_breaker": "daemon_lances",
    "overburn_reactors": "root_breaker",
    "seismic_lattice": "root_breaker",
    "auto_salvage": "root_breaker",
    "mantle_drills": "overburn_reactors",
    "strata_drone": "seismic_lattice",
    "fault_charges": "auto_salvage",
    "drone_frenzy_thrusters": "strata_drone",
    "void_cutters": "fault_charges",
    "inversion_drives": "void_cutters",
    "vault_pulsers": "void_cutters",
    "gravity_wells": "void_cutters",
    "drone_split_lasers": "inversion_drives",
    "core_mining_drone": "vault_pulsers",
    "abyssal_rigs": "gravity_wells",
    "drone_frenzy_harvesters": "core_mining_drone",
    "mirror_saws": "abyssal_rigs",
    "fault_harpoons": "mirror_saws",
    "null_borers": "mirror_saws",
    "ash_crowns": "mirror_saws",
    "drone_frenzy_matrix": "fault_harpoons",
    "mining_speed_servos": "ash_crowns",
...
const RAW_NODE_DATA := {
    ...
    "minimap": {"base_cost": 5, "cost_mult": 1.0, "max_level": 1, "phase": 1, "label": "Minimap", "summary": "Unlock the pit minimap during runs.", "icon": "M", "effects": {"minimap_unlock": true}},
    ...
    "root_breaker": {"base_cost": 980, "cost_mult": 2.05, "max_level": 9, "phase": 3, "label": "Root Breaker", "summary": "Unlock 3x daemon core damage and add +18 cargo capacity per level. Buying any phase-3 node unlocks Empire Layer 3 runs after clearing the second layer.", "icon": "X", "effects": {"core_breaker_unlock": true, "cargo_expand": 18.0}},
    ...
    "inversion_drives": {"base_cost": 5800, "cost_mult": 2.12, "max_level": 14, "phase": 4, "label": "Inversion Drives", "summary": "+40 move speed, +10 max power, and +31 cargo capacity per level.", "icon": "I", "effects": {"speed": 40.0, "power_capacity": 10.0, "cargo_expand": 31.0}},
    "vault_pulsers": {"base_cost": 18000, "cost_mult": 2.15, "max_level": 16, "phase": 4, "label": "Power Reservoirs", "summary": "+20 max power and +36 cargo capacity per level.", "icon": "P", "effects": {"power_capacity": 20.0, "cargo_expand": 36.0}},
...
static func get_clear_reward_core_upgrades_for_layer_progress(layer_clear_percents: Dictionary) -> Array[String]:
    var rewards: Array[String] = []
    for reward_id in REWARD_CORE_UPGRADES:
        var layer_depth: int = get_reward_core_upgrade_target_layer_depth(reward_id)
        var target_percent: float = get_reward_core_upgrade_target_percent(reward_id)
        var current_percent: float = float(layer_clear_percents.get(layer_depth, 0.0))
        if current_percent >= target_percent:
            rewards.append(CORE_PREFIX + reward_id)
    return rewards

static func get_reward_core_upgrade_target_percent(upgrade_id: String) -> float:
    var trimmed: String = upgrade_id.trim_prefix(CORE_PREFIX)
    match trimmed:
        "clear_proxy_25", "clear_cipher_25", "clear_ghost_25", "clear_kernel_25":
            return 25.0
        "clear_proxy_50", "clear_cipher_50", "clear_ghost_50", "clear_kernel_50":
            return 50.0
        "clear_proxy_75", "clear_cipher_75", "clear_ghost_75", "clear_kernel_75":
            return 75.0
        _:
            return 0.0

static func get_reward_core_upgrade_target_layer_depth(upgrade_id: String) -> int:
    var trimmed: String = upgrade_id.trim_prefix(CORE_PREFIX)
    match trimmed:
        "clear_proxy_25", "clear_proxy_50", "clear_proxy_75":
            return 1
...
static func build_runtime_stats(upgrades: Dictionary, xp_upgrades: Dictionary = {}, core_upgrades: Dictionary = {}) -> Dictionary:
    ...
    var flags := {
        ...
        "drone_overclock": false, "mega_laser_unlock": false, "overdrive_enhance": false, "power_auto_trigger": false,
    }
    for upgrade_id in upgrades.keys():
        ...
        for effect_key in effects.keys():
            ...
            match effect_id:
                ...
                "power_capacity": power_capacity_bonus += float(effect_value) * level
                "power_gain_mult": power_gain_bonus += float(effect_value) * level
    ...
    for upgrade_id in xp_upgrades.keys():
        ...
        for xp_effect_key in xp_effects.keys():
            ...
            match xp_effect_id:
                ...
                "power_capacity": power_capacity_bonus += float(xp_effect_value) * xp_level
                "power_gain_mult": power_gain_bonus += float(xp_effect_value) * xp_level
    ...
    for upgrade_id in core_upgrades.keys():
        ...
        for core_effect_key in core_effects.keys():
            ...
            match core_effect_id:
                ...
                "power_capacity": power_capacity_bonus += float(core_effect_value) * core_level
    ...
    return {
        ...
        "mining_drone_count": mining_drone_count,
        "mining_drone_tier": clampi(mining_drone_tier, 0, 4),
        ...
        "shockwave_trigger_kills": max(8, 18 - shockwave_enhance_count),
        "shockwave_radius_cells": mini(5, 3 + shockwave_enhance_count),
        "mega_enabled": false,
        ...
        "power_capacity": 100.0 + power_capacity_bonus,
        "power_gain_mult": 1.0 + power_gain_bonus,
        "power_auto_trigger": flags["power_auto_trigger"],
...
static func _get_summary(upgrade_id: String, effects: Dictionary) -> String:
    var summaries := {
        ...
        "shockwave_unlock": "Unlock seismic bursts every 15 kills in a 6-cell radius.",
    ...
    if effects.has("shockwave_enhance"):
        return "Seismic bursts trigger 2 kills sooner and reach 2 more cells per level."
